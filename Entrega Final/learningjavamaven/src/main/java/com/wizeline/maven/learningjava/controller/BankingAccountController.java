...
public class BankingAccountController {
	...
	@PutMapping("/Accounts")
	public ResponseEntity<String> putAccounts() {
		List<BankAccountModel> accounts = bankAccountService.getAccounts();
		((BankingAccountController) bankAccountService).putAccounts();
		return new ResponseEntity<>("Reename country", HttpStatus.OK);
	}
